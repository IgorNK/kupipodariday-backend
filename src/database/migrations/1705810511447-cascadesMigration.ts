...
export class CascadesMigration1705810511447 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "offer" ALTER COLUMN "amount" TYPE numeric`);
        ...
        await queryRunner.query(`ALTER TABLE "wish" ADD CONSTRAINT "FK_9e85e93aa0cb29e1db7517ec10d" FOREIGN KEY ("wishlistId") REFERENCES "wishlist"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
