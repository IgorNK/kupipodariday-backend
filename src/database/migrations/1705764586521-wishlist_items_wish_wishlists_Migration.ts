...
export class WishlistItemsWishWishlistsMigration1705764586521 implements MigrationInterface {
    name = 'WishlistItemsWishWishlistsMigration1705764586521'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "wish" DROP CONSTRAINT "FK_0c39f923c3fdf67dcb9cc1a8804"`);
        ...
        await queryRunner.query(`ALTER TABLE "wishlist_items_wish" ADD CONSTRAINT "FK_20a447bbd8b2e0c58b420300d4d" FOREIGN KEY ("wishId") REFERENCES "wish"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "wish" ADD CONSTRAINT "FK_0c39f923c3fdf67dcb9cc1a8804" FOREIGN KEY ("wishlistsId") REFERENCES "wishlist"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
